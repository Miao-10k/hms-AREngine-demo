 ...
 * @since 2020-10-10
 */
class AugmentedImageVirtualObject(private var augmentedImage: ARAugmentedImage, private var objectColor: FloatArray) {
    /**
...
//    }
     ...
     */
    fun getAugmentedImage() = augmentedImage
    ...
    fun getModelAnchorMatrix(): FloatArray {
        ...
        augmentedImage.centerPose.toMatrix(modelMatrix, 0)
